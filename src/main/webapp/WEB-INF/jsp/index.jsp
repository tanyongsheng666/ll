...
<div id="cc" class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'east',iconCls:'icon-reload',title:'East',split:true" style="width:800px;">
    ...
    <div data-options="region:'center'"     style="padding:5px;background:#eee;width: 500px">
        <ul id="tt1"></ul>
